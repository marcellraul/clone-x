...
export default function PostListTab({ userName, userFullName, avatarUrl, content, createdAt, imageUrl }: { userName: string; userFullName: string; avatarUrl: string; content: string; createdAt: string; imageUrl?: string | null }) {
  return (
